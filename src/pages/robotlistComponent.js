...
export default function App() {
    const [list, setList] = useState([
            ...
            remark:'快销品行业机器人，展示千人千面、业务选项卡、热点问题、多轮对话、自定义订单卡片、分词联想等核心机器人能力。生成的专属聊天页链接可以收藏到地址栏，方便下次直接使用',
            cardflag:'2',
            agentid:'',
            partnerid:'1',
            type:'3',
            ...
            remark:'智能家居行业机器人，展示千人千面、业务选项卡、热点问题、多轮对话、自定义订单卡片、分词联想等核心机器人能力。生成的专属聊天页链接可以收藏到地址栏，方便下次直接使用',
            cardflag:'0',
            agentid:'',
            partnerid:'2',
            type:'3',
            ...
            remark:'企业内部服务机器人，展示千人千面、业务选项卡、热点问题、多轮对话、分词联想等核心机器人能力。生成的专属聊天页链接可以收藏到地址栏，方便下次直接使用',
            cardflag:'0',
            agentid:'',
            partnerid:'3',
            type:'3',
